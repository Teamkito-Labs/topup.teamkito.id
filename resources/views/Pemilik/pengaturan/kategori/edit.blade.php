...
<x-app-layout>
    ...
    <div class="row">
			...
			<div class="card shadow-sm rounded-lg height-card box-margin mx-0 px-0">
				<div class="card-body">
					<ul class="nav nav-tabs nav-bordered">
						<li class="nav-item">
							<a href="#menu-produk" data-toggle="tab" aria-expanded="false" class="nav-link @if(Request::segment(4) == 'produk') active @endif">
								Produk
							</a>
						</li>
						<li class="nav-item">
							<a href="#menu-kategori" data-toggle="tab" aria-expanded="false" class="nav-link @if(Request::segment(4) == 'kategori') active @endif">
								Kategori
							</a>
						</li>
						<li class="nav-item">
							<a href="#menu-brand" data-toggle="tab" aria-expanded="false" class="nav-link @if(Request::segment(4) == 'brand') active @endif">
								Brand
							</a>
						</li>
						<li class="nav-item">
							<a href="#menu-tipe" data-toggle="tab" aria-expanded="false" class="nav-link @if(Request::segment(4) == 'tipe') active @endif">
								Tipe
							</a>
						</li>
					</ul>
		...
		@include('pemilik.partials.edit-kategori')
    </div>
    @push('styles')
