                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- Icon -->
                            <div class="icon">
                                <img src="{{ asset('storage/img/bg-img/icon-8.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- Icon -->
                            <div class="icon">
                                <img src="{{ asset('storage/img/bg-img/icon-9.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- Icon -->
                            <div class="icon">
                                <img src="{{ asset('storage/img/bg-img/icon-10.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- Icon -->
                            <div class="icon">
                                <img src="{{ asset('storage/img/bg-img/icon-11.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
