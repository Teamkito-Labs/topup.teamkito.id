...
<x-app-layout>
    ...
    <div class="fixed-bottom d-flex justify-content-end mb-4 mr-5">
        <a href="{{ route('produk.item.tambah', ['produkSlug' => $produk->slug, 'kategoriSlug' => $kategori->slug, 'brandSlug' => $brand->slug]) }}" class="btn btn-primary btn-lg btn-circle"><i class="fa fa-plus"></i></a>
    </div>
    @push('styles')
